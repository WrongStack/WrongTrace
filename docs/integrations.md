...
served by the daemon (default `http://localhost:3444`).
...
./wrongtrace start --watch /path/to/your/project --repo my-app --port 3444
```

Then open <http://localhost:3444> — the dashboard shows live churn as any
